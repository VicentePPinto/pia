...
describe('Assistente de Vendas - E2E Tests', async () => {
    ...
    it.skip('Schedule appointment - Success', async () => {
        const response = await makeARequest(
           // `Gostaria de agendar uma reunião de apresentação de produto para dia 07 de maio as 10h,  com o Sr. João Silva`,
            `Agende uma reunião dia 16 de maio às 10h com Carlos Oliveira para tratarmos da compra da moto`,
           1
    ...
    it('Schedule appointment - Success', async () => {
        const response = await makeARequest(
           // `Gostaria de agendar uma reunião de apresentação de produto para dia 07 de maio as 10h,  com o Sr. João Silva`,
            `Preciso remarcar a reunião dia 16 de maio às 10h com Carlos Oliveira, para dia 16 de maio as 14h devido a solicitação do cliente`,
           1
